...
def test_is_positive():
    assert is_positive(5), "Expected 5 to be positive"
    assert not is_positive(-3), "Expected -3 to be not positive"
    assert not is_positive(0), "Expected 0 to be not positive"
